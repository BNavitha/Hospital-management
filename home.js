...
import './home.css'
import logouticon from './images/loginbg.jpg'
        ...
        return(
            <div className='fullheight'>
                <div className='header'>
                    <label style={titlestyle}>Airline Reservation System </label>
                ...
                <div className='content'>
                    ...
                    <div className='outlet'>
                        <div id='titlebar'></div>
                        <frame id='module' src="" ></frame>
                    </div>
                </div>
                <div className='footer'>Copyright @ airline Reservation system. All rights reserved.</div>
            </div>
        );
    }
}
