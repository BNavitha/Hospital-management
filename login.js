...
function Login(){
    ...
    return(
        <div className='fullheight'>
            <div id='loginheader' className='loginheader'>Airline Reservation system</div>
            <div id='logincontent'>
            ...
            <div id='loginfooter'>Copyright @ airline Reservation system. All rights reserved.</div>
        </div>
    );
}
